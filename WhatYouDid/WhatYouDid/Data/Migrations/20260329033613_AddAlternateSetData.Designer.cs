...
namespace WhatYouDid.Migrations
{
    ...
    [Migration("20260329033613_AddAlternateSetData")]
    partial class AddAlternateSetData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhatYouDid.Data.Workout", b =>
                {
                    ...
                    b.HasIndex("ApplicationUserId", "StartTime")
            ...
            modelBuilder.Entity("WhatYouDid.Data.WorkoutExerciseSet", b =>
                {
                    b.Property<int>("WorkoutExerciseSetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("WorkoutExerciseSetId"));

                    b.Property<int?>("AlternateDuration")
                        .HasColumnType("int");

                    b.Property<int?>("AlternateReps")
                        .HasColumnType("int");

                    b.Property<int?>("AlternateWeight")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WhatYouDid.Data.WorkoutExerciseSet", b =>
                {
                    b.HasOne("WhatYouDid.Data.WorkoutExercise", "WorkoutExercise")
                        .WithMany("Sets")
